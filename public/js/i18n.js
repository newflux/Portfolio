(function () {
  ...
  const T = {
    ...
    'index.title': 'Santosh V, Creative Developer',
    'index.h1': 'Santosh V, Creative Developer, Software Engineer in Bangalore, India, specialized in web development, animation and interactive design.',
    ...
    'index.about.sub': "My name is Santosh. A passionate creator and Software Engineer in Bangalore, India, I build memorable digital experiences, always seeking the symbiosis between art and information.",
    ...
    'index.skills.text': 'Computer Science student in Bangalore, India, specialized in cybersecurity, passionate about web development and design.',
    ...
    'index.contact.dispo1': "Currently building <span class=\"other-accent\">Brain-Computer Interfaces</span> and exploring embedded hardware. Always eager to push the boundaries of reality through code and design.",
    ...
    'info.title': 'Info, Santosh V',
    'info.eyebrow': 'About',
    'info.role': 'Creative developer & Software Engineer, specialized in web development.',
    ...
    'info.meta.based.value': 'Bangalore, India, France',
    'info.meta.status.value': '16-week internship — January 2027',
    ...
    'contact.title': 'Contact, Santosh V',
    ...
    'contact.meta.base.value': 'Bangalore, India, France',
    ...
    'works.title': 'Work, Santosh V',
    'works.h1': 'Projects, Santosh V, Creative Developer. Discover my work in web development, animation and interactive design.',
