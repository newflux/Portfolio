...
const html = `  <div className="intro-bg" id="intro-bg"></div>
  ...
  <div className="scroll-wrap" id="scroll-wrap">
    <section className="hero" id="hero">
      <h1 className="sr-only" data-i18n="index.h1">Luke Baffait — Creative Developer, étudiant en informatique à Vannes, spécialisé en développement web, animation et design interactif.</h1>
  ...
  <section className="circle-gallery" id="circle-gallery">
    <div className="circle-gallery-pin" id="circle-gallery-pin">
      <img className="cg-img" src="assets/images/projects/Covers/cyberDiag_web.avif" alt="CyberDiag — site web" width="3000" height="2250" />
      <img className="cg-img" src="assets/images/projects/Covers/Overtake.avif" alt="Overtake — simulateur de course automobile arcade" width="4000" height="3000" />
      ...
      <img className="cg-img" src="assets/images/projects/Covers/Beyond%20the%20clouds.avif" alt="Beyond the Clouds — monde 3D Three.js et WebGL" width="7257" height="5443" />
      <img className="cg-img" src="assets/images/projects/Covers/Zenith.avif" alt="Zenith — navigateur web" width="2667" height="2000" />
      <img className="cg-img" src="assets/images/projects/Covers/SkymcDB.avif" alt="SkymcDB — outil pour builders Minecraft" width="2667" height="2000" />
      <img className="cg-img" src="assets/images/projects/Covers/ChromaBlock.avif" alt="ChromaBlock — version web de SkymcDB" width="2667" height="2000" />
      <img className="cg-img" src="assets/images/projects/Covers/CyberDiag.avif" alt="CyberDiag — application desktop de cybersécurité" width="1333" height="1000" />
      <p className="cg-phrase" id="cg-phrase" data-i18n="index.cg.phrase">Chaque projet est une occasion d'<span className="other-accent">apprendre</span>,
        d'<span className="other-accent">expérimenter</span> et de repousser mes limites.</p>
    </div>
  </section>
  ...
  <path d="M11 38H54L37 21H51L73 43L51 65H37L54 48H11Z"/>
      ...
      <div className="skills-right" id="skills-right">
        <div className="skill-group open" data-group="frontend">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.frontend">Frontend</span><span
        ...
        <div className="skill-group" data-group="animation">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.animation">Animation & 3D</span><span
              className="skill-header-icon"></span></div>
          <div className="skill-body">
            <ul className="skill-body-inner">
              <li>GSAP</li>
        ...
        <div className="skill-group" data-group="backend">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.backend">Backend</span><span
              className="skill-header-icon"></span></div>
          <div className="skill-body">
            <ul className="skill-body-inner">
              <li>Node.js</li>
        ...
        <div className="skill-group" data-group="database">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.database">Bases de données</span><span
              className="skill-header-icon"></span></div>
          <div className="skill-body">
            <ul className="skill-body-inner">
              <li>MySQL</li>
        ...
        <div className="skill-group" data-group="devops">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.devops">DevOps & Outils</span><span
              className="skill-header-icon"></span></div>
          <div className="skill-body">
            <ul className="skill-body-inner">
              <li>Docker</li>
        ...
        <div className="skill-group" data-group="sysadmin">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.security">Système & Sécurité</span><span
              className="skill-header-icon"></span></div>
          <div className="skill-body">
            <ul className="skill-body-inner">
              <li>Linux</li>
        ...
        <div className="skill-group" data-group="design">
          <div className="skill-header"><span className="skill-header-title" data-i18n="index.skills.design">Design</span><span
              className="skill-header-icon"></span></div>
          <div className="skill-body">
            <ul className="skill-body-inner">
              <li>Photoshop</li>
    ...
    <div className="awards-inner">
      ...
      <div className="awards-list" id="awards-list">
        <div className="award-item" data-cursor-img="assets/images/projects/Covers/Portfolio.avif">
          ...
          <div class="award-date">17 05 2026</div>
        </div>
        <div className="award-item" data-cursor-img="assets/images/projects/Covers/Portfolio.avif">
  ...
  <section className="contact" id="contact">
    <div className="contact-pin" id="contact-pin">
      ...
      <div className="contact-dispo" id="contact-dispo">
        <p data-i18n="index.contact.dispo1">À la recherche d'un <span className="other-accent">stage de 16 semaines</span> à partir de janvier 2027. Motivé à rejoindre
          une équipe innovante et à contribuer à des projets ambitieux.</p>
      </div>
      ...
      <div className="contact-dispo" id="contact-dispo-2">
        <p data-i18n="index.contact.dispo2">Je suis disponible pour<span className="other-accent"> des missions en freelance</span> partout dans le monde,
          sur<span className="other-accent"> vos projets ambitieux</span> et des collaborations internationales.</p>
      </div>
  ...
  <section className="project-detail" id="project-detail">
    ...
    <div className="detail-info">
      ...
      <a className="detail-visit chr-hover" id="detail-visit" target="_blank" rel="noopener noreferrer"
        data-chr="VISITER 🡲" data-i18n-attr="data-chr:index.detail.visit"></a>
    </div>
...
const appTsx = `import React, { useEffect, useRef } from 'react';
